...
config = {
    ...
    :postinstall_files => [
        ...
        'build_time.sh', #Done
        'apt_upgrade.sh', #Done
        'configure_grub.sh', #Done
        'configure_locale.sh', #Done > null
        'configure_login.sh', 
        'configure_networking.sh', #Done > null
        'configure_acpid.sh', #Done > null
        # turning it into a systemvm
        'install_systemvm_packages.sh', #Done > check debconf
        'configure_conntrack.sh', #Done > Logging default.
        '../../cloud_scripts_shar_archive.sh',
        'configure_systemvm_services.sh',
        'authorized_keys.sh', #Done > null
